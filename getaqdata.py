...
def navigate_to_fybra_device_details_page(page: Page, env_data):
...
def navigate_to_accuweather_aq_page(page: Page):
    page.goto("https://www.accuweather.com/ro/ro/bucharest/1-287430_18_al/air-quality-index/1-287430_18_al")


def read_fybra_device_values(loaded_page: Page) -> list[str]:
...
def read_accuweather_aq_values(loaded_page: Page) -> list[list[str]]:
    ...
    try:
        with open('environment/environment.json', 'r') as env_file:
            ...
            with sync_playwright() as p:
                ...
                navigate_to_fybra_device_details_page(fybra_page, env_data)
